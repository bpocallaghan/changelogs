...
namespace Bpocallaghan\Changelogs\Commands;
...
class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'changelogs:publish';
    ...
    private function copyModels()
    {
        ...
        // copy files
        $search = "namespace Bpocallaghan\Changelogs\Models;";
    ...
    private function copyViews()
    {
        ...
        $destination = resource_path('views\admin\settings\changelogs');
        $this->copyFilesFromSource($source, $destination);

        // WEBSITE
        $source = $this->basePath . "resources\\views\website";
        $destination = resource_path('views\website');
        $this->copyFilesFromSource($source, $destination);
    }
    ...
    private function copyControllers()
    {
        ...
        $destination = app_path('Http\Controllers\Admin\Settings');

        // copy files
        $search = "namespace Bpocallaghan\Changelogs\Controllers\Admin;";
        $replace = "namespace App\Http\Controllers\Admin\Settings;";
        $this->copyFilesFromSource($source, $destination, $search, $replace);
        ...
        // copy files
        $search = "namespace Bpocallaghan\Changelogs\Controllers\Website;";
        $replace = "namespace App\Http\Controllers\Website;";
        $this->copyFilesFromSource($source, $destination, $search, $replace);
    }
    ...
    private function copyDatabase()
    {
        ...
        $search = "namespace Bpocallaghan\Changelogs\Seeds;";
        ...
        $search = "namespace Bpocallaghan\Changelogs\Migrations;";
        $this->copyFilesFromSource($source, $destination, $search);
    }
     ...
     */
    private function copyFilesFromSource($source, $destination, $search = "", $replace = "")
    {
